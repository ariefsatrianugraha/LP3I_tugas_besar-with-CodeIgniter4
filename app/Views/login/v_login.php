...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card">
            ...
            <?php if (!empty(session()->getFlashdata('gagal_login'))) {?>
                <div class="alert alert-danger">
                    <?= session()->getFlashdata('gagal_login'); ?>
                </div>
            <?php } ?>
            <?php if (!empty(session()->getFlashdata('get'))) {?>
                <div class="alert alert-danger">
                    <?= session()->getFlashdata('get'); ?>
                </div>
            <?php } ?>

            <form action="<?= base_url('login/submit_login') ?>" method="post">
